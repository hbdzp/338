...
public class MstarUtil {
	...
	public Bitmap getFontBmp(Context context, int srcId) {
		Bitmap mBitmap = Bitmap.createBitmap(FONT_BITMAP_WIDTH,
				FONT_BITMAP_HEIGHT, Config.ARGB_8888);
	...
	public Bitmap getFontBmp(Context context, int srcId, int position) {
		...
		canvas.drawText(context.getResources().getString(srcId), position, 95,
				paint);

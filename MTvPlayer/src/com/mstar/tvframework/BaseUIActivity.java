...
public abstract class BaseUIActivity extends Activity {
	 ...
	 */
	public abstract boolean init(String blendFile, String configFile,
			String EtcPath);
	 ...
	 * @param unicodeChar
	 *            The unicode character represented by the entered key char. If
	 *            this is 0, further info will have to be extracted from the
	 *            event object.
	 * @param event
	 *            The event object if further details are needed.
	 * @return True if the event was handled.
	 */
	public abstract boolean keyEvent(int action, int unicodeChar, int keyCode,
			KeyEvent event);

	public abstract boolean render(int drawWidth, int drawHeight,
			boolean forceRedraw);

	public abstract boolean axisEvent(int coordType, int btnType, int action,
			float x, float y, MotionEvent event);

	public abstract boolean runLuaScript(String Script);

	public abstract boolean setImage(Bitmap image, String appName,
	...
	public abstract void callBackSceneChange(String OldSceneName,
			String NewSceneName);

	public abstract void callBackBlendFileChange(String OldFileName,
			String NewFileName);

	public abstract void callBackAxisEvent(int coordType, int btnType,
			int action, float x, float y);

	public abstract void callBackKeyEvent(String sceneName, String objName,
			int action, int unicodeChar, int keyCode);

	public abstract void callBackFocusChange(String SceneName,
			String OldObjName, String NewObjName);

	public abstract void callBackAnimDone(String SceneName, String OldObjName,
			String NewObjName);

	public abstract boolean registerAnimToListen(String SceneName,
			String OldObjName, String NewObjName);

	public abstract boolean unRegisterListenAnim(String SceneName,
			String OldObjName, String NewObjName);

	public abstract void createDynamicTexture(int width, int height,
	...
	public abstract boolean replacewithDynamicTex(String appName,
			String sceneName, String objName, int subEntityID, int techID,
			int passID, int stateID);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (!ret) {
			...
			// LEFT_BTN
			int btnType = 0;
			ret = axisEvent(coordType, btnType, event.getAction(),
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		boolean ret = glView.gameEngine.keyEvent(event.getAction(),
	...
	public class GLsurfaceViewActivity extends BaseGLSurfaceView {
		...
		public class GameEngine {
			...
			public boolean keyEvent(int action, int unicodeChar, int keyCode,
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							// Log.v(TAG, "keyEvent unicodeChar = " +
							// unicodeCharL + ", keyCode = " + keyCodeL +
							// "!! ");
							m_bRet = BaseUIActivity.this.keyEvent(actionL,
									unicodeCharL, keyCodeL, eventL);
						}
					});
				}
				return m_bRet;
			...
			public boolean render(int drawWidth, int drawHeight,
					boolean forceRedraw) {
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							m_bRet = BaseUIActivity.this.render(drawWidthL,
									drawHeightL, forceRedrawL);
						}
					});
				}
				return m_bRet;
			...
			public boolean axisEvent(int coordType, int btnType, int action,
					float x, float y, MotionEvent event) {
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							m_bRet = BaseUIActivity.this.axisEvent(coordTypeL,
									btnTypeL, actionL, xL, yL, eventL);
						}
					});
				}
				return m_bRet;
			...
			public boolean setImage(Bitmap image, String appName,
					String sceneName, String objName, int subEntityID,
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							// if(
							// GLsurfaceViewActivity.this.mEgl.eglGetCurrentContext()
							// != EGL10.EGL_NO_CONTEXT
							// ) {
							m_bRet = BaseUIActivity.this.setImage(imageL,
									appNameL, sceneNameL, objNameL,
			...
			public String queryCurrentFocusObj(String SceneName) {
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							m_strRet = BaseUIActivity.this
									.queryCurrentFocusObj(SceneNameL);
						}
					});
				}
				return m_strRet;
			...
			public String queryCurrentFocusApp(String SceneName, String ObjName) {
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							m_strRet = BaseUIActivity.this
									.queryCurrentFocusApp(SceneNameL, ObjNameL);
						}
					});
				}
				return m_strRet;
			...
			public int queryAnimationStatus(String SceneName) {
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							m_iRet = BaseUIActivity.this
									.queryAnimationStatus(SceneNameL);
						}
					});
				}
				return m_iRet;
			 ...
			 * 
			 * public void callBackSceneChange(String OldSceneName, String
			 * NewSceneName);
			 * 
			 * public void callBackBlendFileChange(String OldFileName, String
			 * NewFileName);
			 * 
			 * public void callBackAxisEvent(int coordType, int btnType, int
			 * action, float x, float y);
			 * 
			 * public void callBackKeyEvent(String sceneName, String objName,
			 * int action, int unicodeChar, int keyCode);
			 * 
			 * public void callBackFocusChange(String SceneName, String
			 * OldObjName, String NewObjName);
			 * 
			 * public void callBackAnimDone(String SceneName, String OldObjName,
			 * String NewObjName);
			 */
			public boolean registerAnimToListen(String SceneName,
					String OldObjName, String NewObjName) {
				final String SceneNameL = SceneName;
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							m_bRet = BaseUIActivity.this.registerAnimToListen(
									SceneNameL, OldObjNameL, NewObjNameL);
						}
					});
				}
				return m_bRet;
			...
			public boolean unRegisterListenAnim(String SceneName,
					String OldObjName, String NewObjName) {
				final String SceneNameL = SceneName;
				final String OldObjNameL = OldObjName;
				final String NewObjNameL = NewObjName;
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							m_bRet = BaseUIActivity.this.unRegisterListenAnim(
									SceneNameL, OldObjNameL, NewObjNameL);
						}
					});
				}
			...
			public void createDynamicTexture(int width, int height,
					int num_mips, String pixelFormat, String name,
					String group, int texType, int usage,
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							BaseUIActivity.this.createDynamicTexture(widthL,
									heightL, num_mipsL, pixelFormatL, nameL,
									groupL, texTypeL, usageL,
			...
			public boolean replacewithDynamicTex(String appName,
					String sceneName, String objName, int subEntityID,
					int techID, int passID, int stateID) {
				final String appNameL = appName;
				final String sceneNameL = sceneName;
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							m_bRet = BaseUIActivity.this.replacewithDynamicTex(
									appNameL, sceneNameL, objNameL,
									subEntityIDL, techIDL, passIDL, stateIDL);
						}
					});
			...
			public void setVECaptureAttr(String attribute, int value) {
				...
				synchronized (this) {
					mMsEventQueue.add(new Runnable() {
						public void run() {
							BaseUIActivity.this.setVECaptureAttr(attributeL,
									valueL);
						}
					});
				}
		...
		private class ContextFactory implements
				BaseGLSurfaceView.EGLContextFactory {
		...
		private class ConfigChooser implements
				BaseGLSurfaceView.EGLConfigChooser {
		...
		private class Renderer implements BaseGLSurfaceView.Renderer {
				...
				try {
					...
					while (true) {
						synchronized (BaseUIActivity.this.glView.gameEngine) {
							...
							if (!BaseUIActivity.this.glView.mMsEventQueue
									.isEmpty()) {
								eventR = BaseUIActivity.this.glView.mMsEventQueue
										.remove(0);
							}
						}
						if (eventR == null)
					...
					BaseUIActivity.this.render(surfaceWidth, surfaceHeight,
							true);
			...
			public void onSurfaceCreated(GL10 gl, EGLConfig config) {
				BaseUIActivity.this.init(blendFile, configFile,

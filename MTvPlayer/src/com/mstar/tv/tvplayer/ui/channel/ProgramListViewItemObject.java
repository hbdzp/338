...
public class ProgramListViewItemObject {
	private String tvNumber = null;

	private String tvName = null;

	private boolean favoriteImg = false;

	private boolean skipImg = false;

	private boolean sslImg = false;

	private short serviceType = K_Constants.SERVICE_TYPE_ATV;

	private boolean lockImg = false;
	...
	public boolean isFavoriteImg() {
		return favoriteImg;
	}

	public void setFavoriteImg(boolean favoriteImg) {

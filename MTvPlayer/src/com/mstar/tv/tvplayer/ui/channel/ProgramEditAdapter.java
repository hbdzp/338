...
public class ProgramEditAdapter extends BaseAdapter {
	...
	public ProgramEditAdapter(Context context,
			ArrayList<ProgramListViewItemObject> data) {
		mData = data;
		activity = context;
	}
	...
	public View getView(int index, View view, ViewGroup arg2) {
		view = LayoutInflater.from(activity).inflate(
				R.layout.program_list_view_item, null);
		TextView tvnumber = (TextView) view
				.findViewById(R.id.program_edit_number);
		...
		ImageView favimage = (ImageView) view
				.findViewById(R.id.program_edit_favorite_img);
		...
		ImageView sslimage = (ImageView) view
				.findViewById(R.id.program_edit_ssl_img);
		...
		ImageView lockimage = (ImageView) view
				.findViewById(R.id.program_edit_lock_img);
		lockimage.setImageResource(R.drawable.list_menu_img_skip_focus);
		if (mData.get(index).isSkipImg()) {
			lockimage.setVisibility(View.VISIBLE);
		} else {
			lockimage.setVisibility(View.GONE);
		}
		ImageView sourceimage = (ImageView) view
				.findViewById(R.id.program_edit_source_img);
		short serviceType = mData.get(index).getServiceType();
		int resId;
		switch (serviceType) {
		case K_Constants.SERVICE_TYPE_ATV:
			resId = R.drawable.list_menu_img_atv_foucus;
			break;
		case K_Constants.SERVICE_TYPE_RADIO:
			resId = R.drawable.list_menu_img_radio_foucus;
			break;
		case K_Constants.SERVICE_TYPE_DTV:
		default:

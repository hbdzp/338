...
public class MultiSelector extends AlertDialog.Builder {
	...
	public AlertDialog.Builder setMultiChoiceItems(CharSequence[] items,
		...
		return super.setMultiChoiceItems(items, checkedItems,
				mMultiChoiceClickLisener);
	}
	...
	public AlertDialog.Builder setSingleChoiceItems(CharSequence[] items,
		...
		return super.setSingleChoiceItems(items, checkedItem,
				mSingleChoiceClickLisener);
	}
